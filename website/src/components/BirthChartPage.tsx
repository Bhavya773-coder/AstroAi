...
const BirthChartPage: React.FC = () => {
  ...
  const drawCosmicWheel = (data: BirthChartData) => {
    ...
    if (data) {
      ...
      // Find zodiac positions
      const sunSignData = zodiacSigns.find(s => s.sign === sunSignName);
      ...
      if (sunSignData) {
        ...
        svg.append("circle")
          ...
          .attr("stroke", "#ff8c00")
          .attr("stroke-width", 2)
          .attr("filter", "drop-shadow(0 0 8px rgba(255, 215, 0, 0.6))");
      ...
      if (moonSignData) {
        ...
        svg.append("circle")
          ...
          .attr("stroke", "#808080")
          .attr("stroke-width", 2)
          .attr("filter", "drop-shadow(0 0 6px rgba(192, 192, 192, 0.6))");
